...
export async function moniterWallet(address: PublicKey) {
    ...
    let signatureInfo = await Solana_Connection.getSignaturesForAddress(address, {limit: 20});
...
const monitoredAddress = new PublicKey('FhG2n7e55DqUDLRJi2ho8MrUhF7cipE9PdS7vZsk4FCa');
